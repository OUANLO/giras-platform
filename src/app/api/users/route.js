...
export async function GET(request) {
  try {
    ...
    let query = supabase
      .from('users')
      .select('id, username, nom, prenoms, structure, superieur_existe, superieur, poste, type_utilisateur, statut, acces_risque, acces_activite, acces_indicateur, acces_tb, acces_perform, acces_admin, date_creation')
...
export async function PUT(request) {
  try {
    ...
    const { data, error } = await supabase
      ...
      .update(updateData)
      .eq('id', body.id)
      .select('id, username, nom, prenoms, structure, superieur_existe, superieur, poste, type_utilisateur, statut')
      .single()
