...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center px-4 py-6 sm:p-4">
      {/* Effets de fond */}
      ...
      {/* Carte de connexion */}
      <div className="relative bg-white/10 backdrop-blur-xl rounded-[28px] p-5 sm:p-8 w-full max-w-md shadow-2xl border border-white/20">
        {/* Logos en haut */}
        <div className="mb-6">
