...
const sections = [
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        content: [
          'La barre de rubriques située en haut permet d’accéder aux grands modules : Accueil, Gestion des risques, Suivi des activités, Suivi des indicateurs, Suivi des performances, Tableau de bord, Rapports, Administration et Aide.',
  ...
  },
  {
    ...
    title: 'Rapports',
    icon: FileText,
    summary: "Génération d'un rapport consolidé exportable en PDF ou en Word.",
    blocks: [
      {
        title: 'Définir le périmètre du rapport',
        content: [
          "Le module Rapports permet de sélectionner les structures à inclure, puis d'activer ou non les volets Risques, Activités et Indicateurs.",
          "Chaque volet respecte strictement le périmètre choisi. Sans structure sélectionnée, aucun rapport n'est généré.",
        ],
      },
      {
        title: 'Exporter le rapport',
        content: [
          "Une fois le rapport généré, vous pouvez l'exporter en PDF ou en Word directement depuis les boutons dédiés.",
          "Le document exporté reprend la structuration visible à l'écran avec les principaux tableaux, chiffres clés et graphiques.",
        ],
      },
    ],
  },
