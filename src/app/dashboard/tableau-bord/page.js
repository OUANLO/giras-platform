...
export default function TableauBordPage() {
  ...
  const fetchBaseData = async () => {
    setLoading(true)
    try {
      const [structRes, groupRes, procRes, catRes, indRes, occRes, actRes, planRes, riskRes, probRes, perRes, allPerRes] = await Promise.all([
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
          ...
          <div className="grid grid-cols-5 gap-3 mb-4">
            ...
            <StatCard title="Atténuation" value={riskStats.tauxAttenuation} icon={TrendingUp} color="green" />
          </div>
